...
'''function 3 to seperate output using a line.'''
def seperateline(dash):
  print(dash * 90)
...
seperateline("_ ")# called function 3  
    ...
    for j in x:
        for k in y:
            for l in z:
                ...
                print("moduleretriever",moduleretriever,"      :",k*"*")
                print("exclude",exclude,":",l*"*")
...
header = ["progress  ","moduletrailer  ","moduleretriever  ","exclude  " ]
print(''.join(header))
...
seperateline("_ ")#called function 3
#part 4
#reference - w3schools (2021) filehandling . Available at: https://www.w3schools.com/python/python_file_handling.asp (Accessed: 2 december 2021).

for progress in progression_outcome:   
  f  = open('Textfile.txt','a')#This code will append  data to the end of the Textfile.txt file
  f.write((f"{progress} \n"))#f string 
  f.close
print("Progression data stored in the text file") 
